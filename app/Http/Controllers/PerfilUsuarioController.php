...
{
    public function getPerfilesUsuarios(Request $request) {
        $model = new PerfilUsuario();

        $datos = $model->get_perfiles_usuarios($request);
    ...
    public function crearPerfilesUsuarios(Request $request) {
        ...
        try {
            $db = $model->crud_perfiles_usuarios($request, 'C');
    ...
    public function actualizarPerfilesUsuarios(Request $request) {
        $model = new PerfilUsuario();

        try {
            $db = $model->crud_perfiles_usuarios($request, 'U');
